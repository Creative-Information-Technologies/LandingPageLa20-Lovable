    ...
    <div className="min-h-screen w-full">
      ...
      <div className="w-full py-16 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            >
              <p><strong>1.</strong> En una sartén grande, calienta el aceite a fuego medio. Cocina las salchichas durante 8-10 minutos, volteándolas ocasionalmente hasta que estén doradas por todos lados. Retira y reserva.</p>
              <p><strong>2.</strong> En la misma sartén, agrega la cebolla picada y cocina hasta que esté translúcida, aproximadamente 5 minutos. Añade el ajo y cocina por 1 minuto más.</p>
              <p><strong>3.</strong> Incorpora el ketchup, el agua, el curry en polvo y el pimentón. Mezcla bien y deja cocinar a fuego lento durante 10 minutos, revolviendo ocasionalmente.</p>
              <p><strong>4.</strong> Corta las salchichas en rodajas de 2-3 cm y agrégalas a la salsa. Cocina por 5 minutos más para que se integren los sabores.</p>
              <p><strong>5.</strong> Prueba y ajusta la sazón con sal y pimienta al gusto. Sirve caliente acompañado de papas fritas y tu cerveza LA20 favorita.</p>
            </div>
          </div>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        >
          <path
            fill="#000000"
            d="M0,80 C360,140 1080,20 1440,90 L1440,0 L0,0 Z"
          />
        </svg>
        ...
        >
          <div className="animate-marquee whitespace-nowrap">
            <span
              className="inline-block font-bold text-white uppercase mx-6"
              style={{
                fontSize: "18px",
                fontFamily: "Montserrat, sans-serif",
                letterSpacing: "1px",
