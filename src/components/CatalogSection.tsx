...
import laJefaBottle from "@/assets/beer-bottle-la-jefa-bottle.png";
import laJefaGlass from "@/assets/beer-glass-la-jefa-new.png";
import elCheleGlass from "@/assets/beer-glass-el-chele.png";
import alerosBottleReal from "@/assets/beer-bottle-aleros-explore.png";
import laMeticheBottleReal from "@/assets/beer-bottle-la-metiche.png";
import weissBottleReal from "@/assets/beer-bottle-weiss.png";
import viennaBottle from "@/assets/beer-bottle-vienna.png";
import laJefaBottleCatalog from "@/assets/beer-bottle-la-jefa.png";
import laJefaGlassCatalog from "@/assets/beer-glass-la-jefa.png";
import laFlakaBottleFinal from "@/assets/beer-bottle-la-flaka.png";
import genericGlass1 from "@/assets/beer-glass-left.png";
import genericGlass2 from "@/assets/beer-glass-right.png";
import genericGlass3 from "@/assets/beer-glass-dark.png";
import laMeticheBottleLeft from "@/assets/beer-bottle-1.png";
import laMeticheBottleRight from "@/assets/beer-bottle-2.png";
import laMeticheGlassNew from "@/assets/beer-glass-dark.png";
import laMeticheCharacterNew from "@/assets/character-purple.png";
import wavyPatternPurple from "@/assets/wavy-pattern.png";
import wavyPatternBrown from "@/assets/wavy-pattern-brown.png";
import alerosCarousel from "@/assets/beer-bottle-aleros-explore.png";
import elCheleCarousel from "@/assets/beer-bottle-el-chele.png";
import laFlakaCarousel from "@/assets/beer-bottle-la-flaka.png";
import laJefaCarousel from "@/assets/beer-bottle-la-jefa.png";
import weissbierCarousel from "@/assets/beer-bottle-weiss.png";
...
const CatalogSection = () => {
  ...
  return (
    <>
      <section id="catalogo" className="relative w-full py-16" style={{ backgroundColor: "#F7931E" }}>
        <div className="container mx-auto max-w-[1400px] px-8">
          ...
          <div className="grid grid-cols-3 gap-x-12 gap-y-16">
            ...
            <div className="col-span-3 flex justify-center gap-24 mt-8">
      ...
      >
        ...
        {/* Main Content */}
        <div className="container mx-auto max-w-[1200px] px-16 relative z-10 pt-8">
          {/* Title */}
          <h2
            className="uppercase"
            style={{
          ...
          <div className="relative" style={{ maxWidth: "1200px", width: "100%", height: "650px", margin: "0 auto" }}>
            {/* Left Bottle */}
            <div className="absolute z-30" style={{ bottom: "-60px", left: "-50px" }}>
              <img
            ...
            {/* Center Glass - Front */}
            <div className="absolute z-35" style={{ top: "280px", right: "100px" }}>
              <img
            ...
            {/* Right Bottle */}
            <div className="absolute z-30" style={{ bottom: "50px", right: "-80px" }}>
              <img
        ...
        <div className="relative w-full bg-black pt-8 pb-20">
          <div className="container mx-auto max-w-[1400px] px-8 relative z-10">
            <div className="flex justify-around items-center">
              ...
              <div className="h-12 w-[2px]" style={{ backgroundColor: "#FF9A01" }} />
              <div className="text-white font-bold uppercase tracking-wide font-montserrat flex flex-col items-center justify-center">
                <div className="text-5xl">YEAR</div>
                <div className="text-5xl">ROUND</div>
                <div className="text-lg">AVAILABLE</div>
              </div>
              <div className="h-12 w-[2px]" style={{ backgroundColor: "#FF9A01" }} />
              <div className="text-white font-bold uppercase tracking-wide font-montserrat flex flex-col items-center justify-center -mt-4">
                <div className="text-5xl">
                  22<span className="text-2xl">OZ</span> 12<span className="text-2xl">OZ</span>
                </div>
                <div className="text-base">SIZES</div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-[1400px] px-8">
            <div className="grid grid-cols-2 gap-16 items-start mb-20">
              ...
              <div className="flex flex-col justify-start pt-12">
                <h3
                  className="text-5xl font-black uppercase mb-8 tracking-tight"
                  style={{
                    fontFamily: "Oswald, sans-serif",
                    color: "#000000",
                  }}
      ...
      <section
        className={`relative w-full py-20 transition-all duration-800 ${
          showMeticheSection ? "opacity-100" : "opacity-0 hidden"
        }`}
      ...
      >
        <div className="container mx-auto max-w-[1400px] px-8">
          ...
          <div
            className="relative rounded-[60px] py-6 px-16 overflow-visible"
            style={{
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-8 items-center">
              ...
              <div className="text-white text-left pl-8">
                <h3 className="text-4xl font-black uppercase mb-6 tracking-wide font-montserrat">INGREDIENTES</h3>
              ...
              <div className="text-white text-right pr-8">
                <h3
                  className="text-6xl font-black uppercase tracking-tight leading-none mb-2"
                ...
                <p className="text-xl uppercase tracking-widest mb-12 font-montserrat">ESTILO</p>

                <div className="flex flex-col items-end">
                  <div className="text-8xl font-black mb-2" style={{ fontFamily: "Oswald, sans-serif" }}>
                    18
                  </div>
                  <p className="text-lg uppercase tracking-wide mb-4 font-montserrat">IBU (AMARGOR)</p>
                  <div className="bg-white rounded-full px-6 py-3 flex gap-2 text-3xl">
      ...
      >
        <div className="w-full">
          ...
          <div className="text-center mb-16">
            ...
            <h2
              className="text-7xl font-black uppercase tracking-wide"
              style={{
                fontFamily: "Oswald, sans-serif",
                color: "#FFFFFF",
          ...
          <div className="relative flex items-center justify-center mb-20 min-h-[720px]">
            {/* Flecha Izquierda */}
            <button
              onClick={prevSlide}
              className="absolute left-6 top-1/2 -translate-y-1/2 z-30 bg-black/50 hover:bg-black/70 rounded-full p-4 transition-all"
              aria-label="Anterior"
            >
              <ChevronLeft size={48} color="white" strokeWidth={3} />
            </button>

            {/* Área del carrusel centrada */}
            <div className="relative w-full h-[680px] mx-auto overflow-hidden">
              {carouselBeers.map((beer, index) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      transform: `translate(-50%, -50%) translateX(${position * 320}px) scale(${scale})`,
            ...
            <button
              onClick={nextSlide}
              className="absolute right-6 top-1/2 -translate-y-1/2 z-30 bg-black/50 hover:bg-black/70 rounded-full p-4 transition-all"
              aria-label="Siguiente"
            >
              <ChevronRight size={48} color="white" strokeWidth={3} />
            </button>
          </div>
