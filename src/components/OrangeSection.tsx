    ...
    >
      ...
      <div className="hidden lg:flex absolute inset-0 items-end justify-center pb-32 z-30">
        <div className="relative">
          ...
          <img src={beerLaMetiche} alt="La Metiche Beer" className={`absolute w-32 md:w-[30rem] h-auto z-[999] transition-all duration-1000 delay-100 ${isVisible ? "opacity-90 scale-100" : "opacity-0 scale-75"}`} style={{ top: "-400px", left: "-300px", transform: "rotate(-31deg)" }} />
