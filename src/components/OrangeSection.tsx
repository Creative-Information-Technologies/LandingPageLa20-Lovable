    ...
    >
      ...
      <div className="hidden lg:flex absolute inset-0 items-end justify-center pb-32 z-30">
        <div className="relative">
          ...
          <img src={beerLaMetiche} alt="La Metiche Beer" className={`absolute w-32 md:w-[30rem] h-auto z-[999] transition-all duration-1000 delay-100 ${isVisible ? "opacity-90 scale-100" : "opacity-0 scale-75"}`} style={{ top: "-250px", left: "-300px", transform: "rotate(-31deg)" }} />
          <img src={beerAleros} alt="Aleros Beer" className={`absolute w-32 md:w-80 h-auto z-10 transition-all duration-1000 delay-200 ${isVisible ? "opacity-90 scale-100" : "opacity-0 scale-75"}`} style={{ top: "-50px", left: "-400px", transform: "rotate(-20deg)" }} />
          <img src={beerLaJefa} alt="La Jefa Beer" className={`absolute w-32 md:w-[30rem] h-auto z-10 transition-all duration-1000 delay-300 ${isVisible ? "opacity-90 scale-100" : "opacity-0 scale-75"}`} style={{ top: "350px", left: "-600px", transform: "rotate(-31deg)" }} />
          <img src={beerLaJefa} alt="La Jefa Beer" className={`absolute w-32 md:w-[30rem] h-auto z-10 transition-all duration-1000 delay-[400ms] ${isVisible ? "opacity-90 scale-100" : "opacity-0 scale-75"}`} style={{ top: "-300px", left: "100px", transform: "rotate(-31deg)" }} />
          <img src={beerLaFlaka} alt="La Jefa Beer" className={`absolute w-32 md:w-[30rem] h-auto z-10 transition-all duration-1000 delay-[500ms] ${isVisible ? "opacity-90 scale-100" : "opacity-0 scale-75"}`} style={{ top: "350px", left: "0px", transform: "rotate(-31deg)" }} />
          <img src={beerWeiss} alt="La Jefa Beer" className={`absolute w-32 md:w-[30rem] h-auto z-10 transition-all duration-1000 delay-[600ms] ${isVisible ? "opacity-90 scale-100" : "opacity-0 scale-75"}`} style={{ top: "-50px", left: "500px", transform: "rotate(-31deg)" }} />
          <img src={beerLaMetiche} alt="La Jefa Beer" className={`absolute w-32 md:w-[30rem] h-auto z-10 transition-all duration-1000 delay-[700ms] ${isVisible ? "opacity-90 scale-100" : "opacity-0 scale-75"}`} style={{ top: "350px", left: "400px", transform: "rotate(-31deg)" }} />
          <img src={beerAleros} alt="Aleros Beer" className={`absolute w-32 md:w-80 h-auto z-10 transition-all duration-1000 delay-[800ms] ${isVisible ? "opacity-90 scale-100" : "opacity-0 scale-75"}`} style={{ top: "-250px", right: "-500px", transform: "rotate(-20deg)" }} />
        </div>
      </div>
