  ...
  return (
    <section className="w-full">
      ...
      <div className="w-full py-32 relative" style={{ backgroundColor: "#974119" }}>
        ...
        {/* Diagonal images */}
        <div
          className="absolute -top-20 -left-15 rounded-2xl transform -rotate-12 hidden lg:block overflow-hidden shadow-2xl border-4 border-white"
          style={{
            width: "420px",
            height: "310px",
        ...
        ></div>
        <div
          className="absolute bottom-80 -right-20 rounded-2xl transform -rotate-12 hidden lg:block overflow-hidden shadow-2xl border-4 border-white"
          style={{
            width: "420px",
            height: "310px",
