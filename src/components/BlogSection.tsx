...
const BlogSection = () => {
  ...
  return (
    <section className="w-full">
      ...
      {/* Wave Divider */}
      <div className="w-full relative" style={{ height: '15cm', backgroundColor: '#974119' }}>
        <svg 
      ...
      <div className="w-full py-20 px-6 relative overflow-visible" style={{ backgroundColor: '#000000' }}>
